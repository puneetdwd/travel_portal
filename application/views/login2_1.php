        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                ...
                <div class="col-md-6 bs-reset">
                    <div class="login-bg" style="background-image:url(<?php echo base_url(); ?>assets/new/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="<?php echo base_url(); ?>assets/images/logo.png" /> 
                    </div>
                </div>-->
                <div class="col-md-6 login-container bs-reset ">
                    <img class="login-logo login-6" src="<?php echo base_url(); ?>DB_crop.png" style="height: 200px;width: 400px;top:-42px;" />
                    <div class="login-content">
                        <h1>Intra Portal Login</h1>
                        <p> Welcome to Intra Portal. Please login to continue...</p>
                        ...
                        <form class="forget-form" action="<?php echo base_url().'users/forgot_password'; ?>" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control placeholder-no-fix form-group" type="email" autocomplete="off" placeholder="Email" name="email_id" /> </div>
                    ...
                    <div class="login-footer">
                        <div class="row bs-reset">
                            <div class="col-xs-12 bs-reset">
                                <div class="login-copyright text-center" style="padding-right:0px;">
                                    <p>Copyright &copy; 2015 IT MIND MAP. All Rights Reserved</p>
                                </div>
                            </div>
                        </div>
                    </div>
