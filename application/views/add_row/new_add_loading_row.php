...
<tr id='<?php echo "row_load_id_" . $count ?>'>
    ...
    <td><input type='text' name='load_bill_no[]' maxlength="15" id='<?php echo "load_bill_no" . $count ?>' class='form-control required' value="0"></td>
    ...
    <td>
        <input type="file" name="<?php echo 'load_attachment_'.$count.'[]';?>" id="<?php echo 'load_attachment_' . $count ?>" multiple="" class="btn green button-submit" style="width:120px !important;">
        <input type="hidden" name="load_reference_id[]" value="<?php echo rand(10000,10000000); ?>">
    </td>
    <td>
