...
<tr id='<?php echo "row_trip_id_" . $count ?>'>
    ...
    <td><input type='number' name='total_trip_cost[]'  id='<?php echo "A_A_" . $count; ?>' value="0" onkeyup="add_ticket_exp('<?php echo $count; ?>');" class='required form-control only_number number intonly'></td>
    <td><input type='number' name='total_trip_tax[]' id='<?php echo "B_B_" . $count; ?>' value="0" onkeyup="add_ticket_exp('<?php echo $count; ?>');" class='required form-control only_number number intonly'></td>
    <td><input type='number' name='total_trip_agency[]' id='<?php echo "C_C_" . $count; ?>' value="0" onkeyup="add_ticket_exp('<?php echo $count; ?>');" class='required form-control only_number number intonly'></td>
