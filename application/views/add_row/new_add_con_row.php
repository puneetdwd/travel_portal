...
<tr id='<?php echo "row_con_id_" . $count ?>'>
    ...
    <td>
        <input type="file" name="<?php echo 'con_attachment_'.$count.'[]';?>" id="<?php echo 'con_attachment_' . $count ?>" multiple="" class="btn green button-submit" style="width:120px !important;">
