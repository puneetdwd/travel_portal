...
?>
<div class="col-md-4 portlet light bordered" style="height: 700px;">
<h4 class="form-section"><spam class="cutm_lbl btn_blue">Train Ticket</spam></h4>
...
<label class="control-label text-left-imp">Ticket Type<span class="required"> * </span>:</label>                                    
<select id="ticket_type" name="ticket_type" class="form-control required"
data-placeholder="Select a Ticket Type"><option value='1'>Normal</option>
<option value='2'>Tatkal</option><option value='3'>Premium</option>
<option value='4'>Window</option></select></div>
...
if ($request['trip_ticket'] != '1') {
?><div class="col-md-4 portlet light bordered" style="height: 700px;">
<h4 class="form-section"><spam class="cutm_lbl btn_blue">Car Ticket</spam></h4>
...
<div class="form-group">
<label class="control-label text-left-imp">Ticket Type<span class="required"> * </span>:</label>                                    
<select id="ticket_type"  name="ticket_type" class="form-control required" data-placeholder="Select a Ticket Type">
<option value='1'>Normal</option><option value='2'>Tatkal</option></select></div>
...
if ($request['trip_ticket'] != '1') {
?><div class="col-md-4 portlet light bordered" style="height: 700px;">
<h4 class="form-section"><spam class="cutm_lbl btn_blue">Bus Ticket</spam></h4>
...
?><div class="col-md-4 portlet light bordered" style="height: 850px;">
...
<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span></div>
<label id="check_in_date-error" class="error" for="check_in_date"></label></div>
...
<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span></div>
<label id="check_out_date-error" class="error" for="check_out_date"></label></div>
...
<div class="form-group"><label class="control-label text-left-imp">Book By<span class="required"> * </span>:</label>                                    
<select class="form-control required select2me" data-placeholder="Select a Location">
<option value='1'>Uber</option><option value='2'>Ola</option><option value='3'>Autp</option></select></div>
...
?>
<div class="col-md-4 portlet light bordered" style="height: 700px;">
<h4 class="form-section"><spam class="cutm_lbl btn_blue">Return Flight Ticket</spam></h4>
...
<div class="form-group"><label class="control-label text-left-imp">Ticket Type<span class="required"> * </span>:</label>                                    
<select id="ticket_type"  name="ticket_type" class="form-control required" data-placeholder="Select a Ticket Type">
<option value='1'>Normal</option></select></div>
...
if ($request['trip_ticket_return'] != '1') {
?><div class="col-md-4 portlet light bordered" style="height:700px;">
<h4 class="form-section"><spam class="cutm_lbl btn_blue">Return Train Ticket</spam></h4>
...
<div class="form-group"><label class="control-label text-left-imp">Ticket Type<span class="required"> * </span>:</label>                                    
<select id="ticket_type"  name="ticket_type" class="form-control required" data-placeholder="Select a Ticket Type">
<option value='1'>Normal</option><option value='2'>Tatkal</option><option value='3'>Premium</option><option value='4'>Window</option></select></div>
...
?>
<div class="col-md-4 portlet light bordered" style="height: 700px;">
<h4 class="form-section"><spam class="cutm_lbl btn_blue">Return Car Ticket</spam></h4>
...
if ($request['trip_ticket_return'] != '1') {
?><div class="col-md-4 portlet light bordered" style="height: 700px;">
<h4 class="form-section"><spam class="cutm_lbl btn_blue">Return Bus Ticket</spam></h4>
...
<div class="form-group"><label class="control-label text-left-imp">Ticket Cost<span class="required"> * </span>:</label>                                    
<input type="number" class="form-control required" name="cost"></div>

<div class="form-group"><label class="control-label text-left-imp">Comment:</label>                                                                            
<textarea class="form-control" rows="4" name="comment"></textarea></div>

<div class="form-group"><label class="control-label text-left-imp">Attach<span class="required"> * </span>:</label>                                                                            
<input type="file" class="form-control required" name="bus_attachment"></div>

<div class="form-actions"><input type="hidden" name="trip_mode" value="1">
<input type="hidden" name="request_id" value="<?php echo $request['request_id']; ?>">
<button class="btn green" type="submit">Submit</button></div></div></div></form></div><?php
}
}
}
}
...
<h4 class="modal-title">Employee Information</h4></div><div class="modal-body">
<table id="basicTable" class="table table-hover table-bordered">
<tbody><tr><td>Employee Id</td><td><?php echo $employee['employee_id'] ?></td></tr>
<tr><td>Name</td><td><?php echo $employee['first_name'] . " " . $employee['last_name'] ?></td></tr>
<tr><td>Gender</td><td><?php echo $employee['gender'] ?></td></tr>
<tr><td>Email</td><td><?php echo $employee['gi_email'] ?></td></tr>
<tr><td>Mobile Number</td><td><?php echo $employee['phone'] ?></td></tr>
<tr><td>Ticket Cost Center</td><td><?php echo $employee['cost_center'] ?></td></tr>
<tr><td>Grade</td><td><?php echo $employee['grade_name'] ?></td></tr>
</tbody></table> </div></div></div></div><?php
...
if(endDateStr != ''){
if(startDateStr>endDateStr){return false;}else {return true;}}else {return true;}};

$.validator.addMethod('filesize', function (value, element, param) {
return this.optional(element) || (element.files[0].size <= param)
}, 'File size must be less than 2MB');
$('#flight_booking').validate({
rules: {flight_provider_id: {required: true},
pnr_number: {required: true},
cost: {required: true,number: true,min: 0},
flight_number: {required: true},
flight_attachment: {required: true,filesize: 2097152,},},
messages: {flight_provider_id: {required: 'Flight provider is required'},
pnr_number: {required: 'PNR Number is required'},
cost: {required: 'Cost is required',number: 'Only Number is allowed'},
flight_number: {required: 'Flight Number is required'},
flight_attachment: {required: 'Flight Attachment is required'},},        
