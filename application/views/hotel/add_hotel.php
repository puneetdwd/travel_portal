...
<div class="page-content">
    ...
    <div class="breadcrumbs">
        <h1>
            <?php echo (isset($hotel) ? 'Edit' : 'Add'); ?> Hotel
        </h1>
    </div>
    <!-- END PAGE HEADER-->
                ...
                <form role="form" class="validate-form" method="post">
                    <div class="form-body">
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="class">Minimum Room Rant:
                                        <span class="required">*</span></label>
                                    <input type="text" class="required form-control" name="amount" id="amount"
                                           value="<?php
                                           if (isset($type))
                                               if ($type == "1") {
                                                   echo "";
