                                                            ...
                                                            foreach ($attachment as $key => $val) {
                                                                if ($val['file_name'] != '') {
                                                                    ...
                                                                    <a class="btn-link" target="_blank" href="<?php echo base_url() . $this->config->item('upload_booking_attch_path') . '/' . $val['file_name']; ?>">
                                                                        <i class="fa fa-eye"></i> <?php echo "View" . $view;
                                                    $view++; ?> 
                                                                    </a><br>
            <?php }
        }
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-3">
                                                <?php if ($request['request_status'] != "8") { ?>
                                                    <input type="number" name="less_advance" onkeyup="received_total()" id="less_advance" value="<?php echo $expense_pending['less_advance']; ?>" class="form-control only_number">
                                                <?php } else { ?>
