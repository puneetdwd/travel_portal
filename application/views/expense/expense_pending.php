                                        ...
                                        <tbody align="left"><tr><th width="15%">Name</th>
                                            ...
                                            <tr><th>Departure Date and Time</th>
                                                ...
                                                <th>Credit Card Number</th><td>
                                                    <b><?php echo $expense_pending['credit_card_number']; ?></b></td></tr>
                                    ...
                                    <table id="da_perticulars" class="table table-hover table-bordered text-center">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($existing_DA_Data) and count($existing_DA_Data) > 0) {
                                                ...
                                                ?></tbody><tfoot><tr><td colspan="5">Includes "expenses on tea/coffee, breakfast, lunch, dinner" and any other incidental expenses.</td><th><?php
                                                            echo $diff->days . ' Days, ';
                                                            echo $diff->h . ' hrs';
                                                            ?></th>
                                                <th>Total (&#8377;)</th><td><b><?php
                                                ...
                                                foreach ($other_con_booking as $key => $value) {
                                                    ...
                                                    <td><?php
                                                        if ($value['con_book_by'] == "1") {
                                                            echo "Uber";
                                                        } elseif ($value['con_book_by'] == "2") {
                                                            echo "Ola";
                                                        } elseif ($value['con_book_by'] == "3") {
                                                            echo "Auto";
                                                        }
...
//$lbl_total_claim_company = $expense_pending['final_total_claim'] - $expense_pending['total_claim'];
                                        ...
                                        <tr style="display:none;"><th>Other Expense By Travel Desk</th><th><?php
                                                ...
                                                ?></th></tr><tr><th>Travel Advance</th><th class="col-md-3"><?php
                                                    if ($expense_pending['less_advance'] == 0) {
