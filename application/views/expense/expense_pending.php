...
<tr>
<td>D.A.</td>
<td><?php if ($request['DA_allowance_actual'] != 1) {
$da_eligibility = $DA_allowance * $day;
if ($hours != '0') {
if ($hours != '') {
if ($hours < 14) {
...
<tr>
<td>Hotel</td>
<td><?php if ($request['hotel_allowance_actual'] != 1) {
...
<tr>
<td>Conveyance</td>
<td><?php  if ($request['convince_allowance_actual'] != 1) {
...
<?php
if (!empty($budget))
echo $budget['budget'] - $budget['remain_budget'];
?>
</b>
</p>
</div>
