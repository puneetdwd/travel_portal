...
<td>
<input type="text" class="form-control" id="bill_no" maxlength="15" name="bill_no" value="<?php echo $value['bill_no']; ?>">
...
?>"></td><td><?php echo $value['location'] ?></td>
<td>
<?php if ($value['attachment'] != '') { ?>
<a class="btn-link" target="_blank" href="<?php echo base_url() . $this->config->item('upload_booking_attch_path') . '/' . $value['attachment']; ?>">
<i class="fa fa-eye"></i> View </a>
<?php } ?></td>
<td><select name="<?php echo 'load_arrange_by_' . $i ?>" onchange='received_total()' id="<?php echo 'load_arrange_by_' . $i ?>" class="form-control">
...
?><td width="5%" id="<?php echo "loading_total_final_" . $i; ?>"><?php echo $total_loading; ?></td>
</tr><?php
$i++;
}
}
...
<?php $lbltotal3 = $lbltotal3 + $value['cost']; ?></td>
<td width="10%">
<?php // echo $value['cost'];        ?>
...
<td>
<input type="file" name="<?php echo 'other_attachment_' . $i . '[]'; ?>" id="<?php echo 'con_attachment_' . $i ?>" multiple="" class="btn green button-submit" style="width:120px !important;">
<input type="hidden" name="other_reference_id[]" value="<?php echo $value['reference_id']; ?>">
</td>
...
<input type='hidden' name='other_expense_id[]' value="<?php echo $value['id'] ?>">
</td>
</tr>
<?php
if ($value['arrange_by'] == "Company") {
...
<th id="lblother_manager_expense">
<?php
if (isset($other_manager_expense)) {
