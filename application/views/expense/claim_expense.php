...
function find_DA_rows($fromDate, $toDate, $cityGrade, $empGrade) {//30-08-2017 06:00
	...
	$calculatedToDate= $tt.' '.$Begin[1].
	$fir= strtotime($toDate);
	$sec= strtotime($calculatedToDate);
	if($fir>$sec)
	 {
	  $allDuringDates[]= $tt;
	 }
                                    ...
                                    <table id="ticket_table" class="table table-hover table-bordered text-center">
                                        ...
                                        <tbody id="trip_tbody">
                                            ...
                                            foreach ($ticket_details as $key => $value) {
                                                ...
                                                if (isset($value['travel_class'])) {
                                                    $thisRED = $thisRED . '/' . $value['travel_class'];
                                                }
                                                if ($thisRED != $toSetRedFlag1) {
                                                    $checkRed = 'danger';
                                                }
                                                ...
                                                <tr class="<?php echo $checkRed; ?>">
                                                    ...
                                                    <td width="10%">
                                                        <input type="number" onkeyup="add_native_ticket_exp('<?php echo $i; ?>');" class="form-control only_number" name="<?php echo "ticket_cost_" . $i ?>" id="<?php echo "AAA_" . $i; ?>" value="<?php echo $value['cost']; ?>"></td>
                                                    ...
                                                    <td width="10%"><?php
                                                        ...
                                                        ?>
                                                        <input type="number" readonly="true" class="form-control only_number" id="<?php echo "ticket_cost_" . $i ?>" value="<?php echo $value_cost; ?>">
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
                                            ...
                                            if (!empty($other_trip_expense)) {
                                                foreach ($other_trip_expense as $key => $value) {
                                                    ?><tr id="<?php echo "row_trip_id_" . $i ?>">
                                                        ...
                                                        <td>
                                                            <input style="width: 120px !important;" type="file" name="<?php echo 'trip_attachment_' . $i . '[]'; ?>" id="<?php echo 'trip_attachment_' . $i ?>" multiple="" class="btn green button-submit">
                                                            <input type="hidden" name="reference_id[]" value="<?php echo $value['reference_id']; ?>">
                                                        </td>
                                                        <td><input type='number' name='total_trip_cost[]'  id='<?php echo "A_A_" . $i; ?>' value="<?php echo $value['cost']; ?>" onkeyup="add_ticket_exp('<?php echo $i; ?>');" class='required form-control only_number number intonly'></td>
                                                        <td><input type='number' name='total_trip_tax[]' id='<?php echo "B_B_" . $i; ?>' value="<?php echo $value['tax']; ?>" onkeyup="add_ticket_exp('<?php echo $i; ?>');" class='required form-control only_number number intonly'></td>
                                                        <td><input type='number' name='total_trip_agency[]' id='<?php echo "C_C_" . $i; ?>' value="<?php echo $value['agency_cost']; ?>" onkeyup="add_ticket_exp('<?php echo $i; ?>');" class='required form-control only_number number intonly'></td>
...
//COPY FROM ABOVE $ticket_cost_1 = $ticket_cost_1 + $value_cost;
                        ...
                        ?><div class="row"><div class="col-md-12 light bordered">
                                <h4 class="form-section">Guest House/Hotel/Own Arrangement</br>(<span style="color:#005982;">Your Eligibility-&#8377;<?php
                                        ...
                                        <tbody id="load_tbody">
                                            ...
                                            if (!empty($hotel_details)) {
                                                foreach ($hotel_details as $key => $value) {
                                                    ...
                                                    if ($daysInThisHotel1 > 0) {
                                                        $stays1 = $daysInThisHotel1;
                                                    }
                                                    $perdayCostOfHotel1 = $total_loading1 / $stays1;
                                                    $trClassHotel1 = '';
                                                    if ($GH_Act > 0 and is_numeric($GH_Act) and $perdayCostOfHotel1 > $GH_Act) {
                                                        $trClassHotel1 = 'danger';
                                                    }
                                                    ?><tr class="<?php echo $trClassHotel1; ?>">
                                                        <td></td>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php
                                                            if (isset($value['arrangement_type'])) {
                                                                echo $value['arrangement_type'];
                                                            }
                                                            ?></td>
                                                        ...
                                                        <td>
                                                            <div class="input-group date form_datetime" data-date="<?php echo isset($value['date_to']) ? $value['date_to'] : date("Y-m-d", strtotime("+1 day")); ?>T018:00:00Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                                                                <input name="date_to_1" id='date_to_1' class="form-control required shouldLessThanReturn" size="16" type="text" readonly value="<?php
                                                        ...
                                                        <td class="col-md-1"><input type="text" class="form-control" id="bill_no_1" maxlength="15" name="bill_no_1" value="<?php
                                                            if ($value['bill_no_1'] == '') {
                                                                echo 0;
                                                            } else {
                                                        ...
                                                        <td class="col-md-1"><input type="number" class="form-control only_number" onkeyup="received_total();" name="other_expense_1" id="other_expense_1" value="<?php
...
//$lbltotal1 = $lbltotal1 + $total_loading;
                                                ...
                                                if ($daysInThisHotel > 0) {
                                                    $stays = $daysInThisHotel;
                                                }
                                                $perdayCostOfHotel = $total_loading / $stays;
                                                $trClassHotel = '';
                                                if ($GH_Act > 0 and is_numeric($GH_Act) and $perdayCostOfHotel > $GH_Act) {
                                                    $trClassHotel = 'danger';
                                                }
                                                ?><tr class="<?php echo $trClassHotel; ?>" id="<?php echo "row_load_id_" . $i ?>">
                                                    ...
                                                    <td><?php echo $i; ?></td>
                                                    <td>
                                                        <input type="hidden" name="arrangement_type[]" value="<?php
                                                        if (isset($value['arrangement_type'])) {
                                                            echo $value['arrangement_type'];
                                                        }
                                                        ?>">
                        ...
                        <div <?php echo $DA_style; ?> class="row"><div class="col-md-12 light bordered">
                                ...
                                <div class="row">
                                    ...
                                    <table id="da_perticulars" class="table table-hover table-bordered text-center">
                                        <thead>
                                            <tr class="th_blue">
                                                ...
                                                if (isset($DA_50) and $DA_50 > 0) {
                                                    if ($DA_50 == 3) {
                                                        echo ' (Policy : DA is Not Admissible)';
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($existing_DA_Data) and count($existing_DA_Data) > 0) {
                                                foreach ($existing_DA_Data as $key => $val) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td title="If you do not want to claim this DA, please uncheck it.">
                                                            <input class="da_cb" rel="<?php echo $to_add_sustract; ?>" rel2="<?php echo 'rec_' . $i; ?>" value="1" type="checkbox" name="<?php echo 'claim_this_' . $i; ?>" <?php
                                                            if ($val['donate'] == 0) {
                                                                echo 'checked="checked"';
                                                            }
                                                            ?> /><?php echo $val['serial']; ?><input type="hidden" value="<?php echo $val['serial']; ?>" name="da_claims_serial[]" readonly />
                                                        </td>
                                                        ...
                                                        <td><?php
                                                            ...
                                                            ?><input type="hidden" value="<?php echo $fullDA_after_policy_1; ?>" name="da_claims_da_per_day[]" readonly />
                                                        </td>
                                                        <td><b id="<?php echo 'a_m_t_' . $i; ?>"><?php
                                                                if ($val['donate'] == 0) {
                                                                    echo $amnt;
                                                                } else {
                                                                    echo 0;
                                                                ...
                                                                ?></b>
                                                            <input id="<?php echo 'tBox_a_m_t_' . $i; ?>" type="hidden" value="<?php
                                                            if ($val['donate'] == 0) {
                                                                echo $amnt;
                                                            } else {
                                                                echo 0;
                                                            }
                                                            ?>" name="da_claims_amount[]" readonly />
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $i++;
                                                ...
                                                foreach ($allDates as $key => $val) {
                                                    ...
                                                    <tr>
                                                        <td title="If you do not want to claim this DA, please uncheck it.">
                                                            <input class="da_cb" rel="<?php echo $amnt; ?>" rel2="<?php echo 'rec_' . $i; ?>" value="1" type="checkbox" name="<?php echo 'claim_this_' . $i; ?>" checked="checked" /><?php echo $i; ?><input type="hidden" value="<?php echo $i; ?>" name="da_claims_serial[]" readonly />
                                                        </td>
                                                        ...
                                                        <td><?php
                                                            ...
                                                            ?><input type="hidden" value="<?php echo $da_to_show; ?>" name="da_claims_da_per_day[]" readonly />
                                                        </td>
                                                        <td><b id="<?php echo 'a_m_t_' . $i; ?>"><?php echo $amnt; ?></b>
                                                            <input id="<?php echo 'tBox_a_m_t_' . $i; ?>" type="hidden" value="<?php echo $amnt; ?>" name="da_claims_amount[]" readonly />
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $i++;
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="5">Includes "expenses on tea/coffee, breakfast, lunch, dinner" and any other incidental expenses.</td>
                                                <th>
                                                    <?php
                                                    echo $diff->days . ' Days, ';
                                                    echo $diff->h . ' hrs';
                                                ...
                                                <th>Total (&#8377;)</th>
                                                <td><b id="da_grand_total_b"><?php echo $total2; ?></b></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                        ...
                        <input type="hidden" class="only_number form-control required" name="da_allowance" id="da_allowance" value="<?php
                        if (!empty($expense_details)) {
                            echo $request['DA_allowance'];
                        } else {
                            echo 0;
                        ...
                        <div class="row"><div class="col-md-12 light bordered">
                                <h4 class="form-section">Conveyance-Car Hire Bills</br>(<span style="color:#005982;">Your Eligibility-&#8377;<?php
                                        if ($con_allo > 0) {
                                            echo $con_allo . '/Day';
                                        } else {
                                            echo 'Actual';
                                    ...
                                    ?><table id="conveyance_car" class="table table-hover table-bordered text-center">
                                        <thead><tr class="th_blue"><th></th><th>#</th><th>Date</th><th>Expense Location</th>
                                            ...
                                            foreach ($car_details as $key => $value) {
                                                $trClassTX = '';
                                                if ($con_allo > 0 and is_numeric($con_allo) and $value['cost'] > $con_allo) {
                                                    $trClassTX = 'danger';
                                                }
                                                ?><tr class="<?php echo $trClassTX; ?>"><td></td><td><?php echo $i; ?></td><td>
                                                    ...
                                                    <td><?php echo $value['location_to']; ?></td><td><?php
                                                        if ($value['book_by'] == "1") {
                                                            echo "Uber";
                                                        } elseif ($value['book_by'] == "2") {
                                                            echo "Ola";
                                                        } elseif ($value['book_by'] == "3") {
                                                            echo "Auto";
                                                        }
                                                        ?></td><td><?php
                                            ...
                                            if (!empty($other_con_booking)) {
                                                foreach ($other_con_booking as $key => $value) {
                                                    $trClassTX2 = '';
                                                    if ($con_allo > 0 and is_numeric($con_allo) and $value['total'] > $con_allo) {
                                                        $trClassTX2 = 'danger';
                                                    }
                                                        ...
                                                        <td><select name="exp_on[]" onChange="received_total();" id="<?php echo "exp_on_" . $i; ?>" class="form-control required">
                                                                ...
                                                                if (isset($possible_halts2) and count($possible_halts2) > 0) {
                                                                    foreach ($possible_halts2 as $kiu => $valu) {
                                                                        ?><option <?php
                                                                        if ($valu == $value['expense_location']) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                        ?> value="<?php echo $valu; ?>"><?php echo $valu; ?></option><?php
                                                                        }
                                                                    }
                                                                    ?></select></td>
...
//$total_travel_claim_hidd = $total_travel_claim;
                        ...
                        if (empty($expense_details)) {
                            echo $total_unpaid_claim_show + $addded_expense_self;
                        } else {
                            echo $total_unpaid_claim_show;
                        }
                        ?>">
                        <input type="hidden" name="final_total_claim" id="final_total_claim" value="<?php
                        if (empty($expense_details)) {
                            echo $total_travel_claim + $addded_expense_self + $addded_expense_com;
                        } else {
                        ...
                        if (empty($expense_details)) {
                            echo $total_unpaid_claim_show + $addded_expense_self - $less_advance - $other_manager_expense;
                        } else {
                            echo $total_unpaid_claim_show - $less_advance - $other_manager_expense;
                        }
                        ?>">
