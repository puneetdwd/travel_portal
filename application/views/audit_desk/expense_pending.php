                                        ...
                                        <tbody>
                                            ...
                                            foreach ($other_trip_expense as $key => $value) {
                                                ...
                                                ?><tr class="<?php echo $checkRed; ?>"><td><?php echo $i++; ?></td>                             
                                                    ...
                                                    <td width="15%"><?php $total = $total + $value['total'];
                                                    echo $value['total'];
                                                        ?></td></tr><?php
                                                if ($value['trip_arrange_by'] == 'Own') {
                                                    $OwnExpenses[] = $value['total'];
                                                }
                                                if ($value['trip_arrange_by'] == 'Company') {
                                                    $expensesByCompany[] = $value['total'];
                                                }
                                            }
                                            ?></tbody>
                                        <tfoot>
...
<?php echo $total . '.00'; ?>
                                    ...
                                    <table id="loading_hotel" class="table table-hover table-bordered text-center">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($hotel_details as $key => $value) {
                                                ...
                                                ?><tr class="<?php echo $trClassHotel1; ?>"><td><?php echo $i; ?></td><td><?php echo $value['hotel_provider_name']; ?></td>
                                                    ...
                                                    <td width="15%"><?php
                                                        ...
                                                        ?></td></tr><?php
                                                if ($value['arrange_by'] == 'Own') {
                                                    $OwnExpenses[] = $total_loading;
                                                }
                                                if ($value['arrange_by'] == 'Company') {
                                                    $expensesByCompany[] = $total_loading;
                                                }
                                            }
                                            ...
                                            ?></tbody><tfoot><tr><td colspan="11"></td><th>Total (&#8377;)</th><td>
                                                    <b <?php echo $sty; ?> ><?php echo $total1 . '.00'; ?></b></td></tr></tfoot></table></div>
                            </div></div><?php
                        $DA_STYLE = '';
                                            ...
                                            if (isset($existing_DA_Data) and count($existing_DA_Data) > 0) {
                                                foreach ($existing_DA_Data as $key => $val) {
                                                    ...
                                                    ?><input type="hidden" value="<?php echo $fullDA_after_policy_1; ?>" name="da_claims_da_per_day[]" readonly /></td>
                                                        ...
                                                        ?>" name="da_claims_amount[]" readonly /></td></tr><?php
                                                        $i++;
                                                    }
                                                }
                                                $t87 = date_create($d1);
    ...
    <?php $total3 = $total3 + $value['cost']; ?>
                                                        ...
                                                        if ($value['arrange_by'] == 'Own') {
                                                            $OwnExpenses[] = $value['cost'];
                                                        }
                                                        if ($value['arrange_by'] == 'Company') {
                                                            $expensesByCompany[] = $value['cost'];
                                                        }
                                                    }
                                                    ...
                                                    if (!empty($value['attachment'])) {
                                                        ...
                                                        foreach ($attachment as $key => $val) {
                                                            if ($val['file_name'] != '') {
                                                                ?><a class="btn-link" target="_blank" href="<?php echo base_url() . $this->config->item('upload_booking_attch_path') . '/' . $val['file_name']; ?>"><i class="fa fa-eye"></i> <?php echo "View" . $view;
                                                $view++;
                                                                ?></a><br><?php
                                                            }
                                                        }
...
$styl2 = '';
if (isset($conELG) and $conELG < $total3) {
    $styl2 = 'style="color:red;"';
}
?>
                                        </tbody>
                                        <tfoot>
                                ...
                                if ($balan >= 0) {
                                    ...
                                    ?><span style="color:red;">Employee will pay to company</span><?php
                                                ...
                                                if ($request['travel_type'] == "1") {
                                                    $travel_mode = "Flight";
                                                } elseif ($request['travel_type'] == "2") {
                                                    $travel_mode = "Train";
                                                } elseif ($request['travel_type'] == "3") {
                                                    $travel_mode = "Car";
                                                } elseif ($request['travel_type'] == "4") {
                                                    $travel_mode = "Bus";
                                                }
