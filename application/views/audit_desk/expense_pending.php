...
echo $da_eligibilityVIEW; ?></span>)</h4>
<div class="row"><?php
$i = 1;
$total2 = 0;
...
?></tbody>
<tfoot><tr><td colspan="5">Includes "expenses on tea/coffee, breakfast, lunch, dinner" and any other incidental expenses.</td><th><?php echo $diff->days.' Days, '; echo $diff->h.' hrs'; ?></th>
