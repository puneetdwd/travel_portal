    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="rejected_member_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php if (isset($member_id)) echo base_url() . 'employee_request/canceled_trip_member/' . $request_id . "/" . $member_id; ?>" id="reject_task1" method="post" class="form-horizontal row-border validate-form">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="widget box">
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="rejected_guest_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php if (isset($member_id)) echo base_url() . 'employee_request/canceled_trip_guest/' . $request_id . "/" . $member_id; ?>" id="reject_task1" method="post" class="form-horizontal row-border validate-form">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="widget box">
