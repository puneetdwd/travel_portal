                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12"><div class="form-group">
                                            ...
                                            <div class="col-md-7 col-xs-7"><p class="text-left-imp">
                                                    <?php if (isset($request['reason']) and $request['reason'] != '') {
                                                        echo $request['reason'];
                                                    } else {
                                                        echo 'Project';
                                                    } ?></p>
                            ...
                            <div class="widget box"><div class="widget-content">
                                    ...
                                    <div class="col-md-12"><div title="While booking the Admin Desk will be considered for upgrade of travel class, meanwhile travelling cost will be increased." class="form-group">                                            
                                            <label class="control-label">
                                                ...
                                                Considering upgrade travel class if required
                                            </label>
                                        </div></div>
                                    ...
                                    <div class="col-md-12"><div class="form-group">
                                            ...
                                            <!--<div class="col-md-12">-->
                                            <textarea name="approve_comment" id="approve_comment" class="form-control" rows="4"></textarea>
                                            <!--</div>-->
                                        </div>
                                    </div>
                                </div>
