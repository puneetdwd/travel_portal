...
<div class="row"><div class="col-md-12 padding_mob">
...
if($data['request_status'] != "9")
 ...
 {
  ?><a class="btn btn-xs blue-chambray" href="<?php echo base_url() . 'employee_request/view_expense/' . $data['id']; ?>"><i class="fa fa-eye"></i> View Approved </a><?php
 }
if($data['request_status'] == "3") {
if($display_flag == "1") {
?><a class="btn btn-xs blue-chambray" 
href="<?php echo base_url() . 'employee_request/self_booking/' . $data['id']; ?>">
<i class="fa fa-edit"></i> Self Booking</a><?php
}
}
...
<a class="btn btn-xs blue-chambray" data-placement="top" data-original-title="View" href="#edit_modal" data-toggle="modal" title="View" data-url="<?php echo base_url() . 'ajax/check_booking/' . $data['id']; ?>" onclick='show_modal(this,<?php echo json_encode($post_data); ?>);' title="View"><i class="fa fa-bus"></i> Request Booking</a>
<?PHP
}
}
...
<i class="fa fa-remove"></i> Trip Cancel
</a>
<?PHP
}
...
if ($data['cancel_status'] == "0") {
?>                                            
<a class="btn btn-xs red" href="<?php echo base_url() . 'employee_request/claim/' . $data['id']; ?>">
<i class="fa fa-eye"></i> Claim Clarification
</a>      
<?php
}
...
<div class="modal-dialog">
<div class="modal-content" id="add_itemt_frm">
