...
<div class="page-content">
    ...
    <div class="breadcrumbs">
        <legend class="border-bottom-none">Car Request</legend>
        <div class="pull-mob">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date form_datetime" data-date="<?php echo isset($travel_request['departure_date']) ? date(DATETIME_FORMAT, strtotime($travel_request['departure_date'])) : date(DATETIME_FORMAT); ?>T07:00Z" data-link-field="dtp_input1">
                                        <input name="departure_date" id="departure_date"  class="form-control required" size="16" type="text" value="<?php echo isset($travel_request['departure_date']) ? date(DATETIME_FORMAT, strtotime($travel_request['departure_date'])) : date(DATETIME_FORMAT); ?> " readonly>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-actions">
                                    <br>
                                    <input type="hidden" id="travel_type" name="travel_type" value="3">                        
                                    <input type="hidden" id="return_travel_type" name="return_travel_type" value="3">                        
        ...
        if (draft != '1') {
            $.ajax({
                ...
                data: {
                    ...
                    'request_number': $('#request_number').val(), 'approval_level': $('#approval_level').val(),
