...
<div class="page-content">
    ...
    <div class="breadcrumbs">
        ...
        <div class="pull-left">
            ...
            <span id="error_msg" class="col-xs-12" style="color:red; padding: 0;"></span>
    ...
    <!-- END PAGE CONTENT-->
</div><script type="text/javascript" src="<?php echo base_url() . "assets/plugins/bootstrap-datetimepicker-master/js/bootstrap-datetimepicker.js" ?>" charset="UTF-8"></script>
