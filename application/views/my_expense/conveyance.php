                ...
                <div class="row">
                    <div class="col-md-4 portlet light bordered paddingBottom10 set-boxes">
                        <?php if (!empty(($request))) { ?>
                            ...
                            <form action="<?php echo base_url('my_expense/save_conveyance'); ?>"  enctype="multipart/form-data" method="post" id="conveyance_form">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <select name="book_by" id="book_by" class="form-control">
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input class="form-control required" name="from_location" id="from_location" aria-required="true" id="from_location" type="text">
                                        </div>
                                        <div class="form-group col-xs-12">
                                            <label class="control-label text-left-imp">To Location<span class="required" aria-required="true"> * </span>:</label>                                    
                                            <input class="form-control required" name="to_location" id="to_location" aria-required="true" id="to_location" type="text">
                                        </div>
                                        <div class="form-group col-xs-12">
                                        ...
                                        <div class="form-group col-xs-12">
                                            ...
                                            <input class="form-control required" name="amount" id="amount" aria-required="true" id="amount" type="number">
                                        </div>

                                        <div class="form-group col-xs-12">
                                            <label class="control-label text-left-imp">Attach:</label>                                                                            
                                            <input class="form-control " name="con_attachment[]" type="file" multiple="">
                                        </div>
                                        <div class="form-actions col-xs-12">     
                                            <label class="control-label text-left-imp">&nbsp;</label>
                                            <input type="hidden" name="con_reference_id" value="<?php echo rand(10000, 10000000); ?>">
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#conveyance_form').validate({
                                                    ...
                                                    messages: {
                                                        ...
                                                        from_location: {
                                                            required: 'Please add From Location',
                                                        },
                                                        to_location: {
                                                            required: 'Please add To Location',
                                                        },
                                                        paid_by: {
                                                            required: 'Please add Paid by',
                                                        },
                                                        amount: {
