                ...
                <div class="form-body">
                    ...
                    <div class="row">
                                        ...
                                        <h4 class="form-section marginLeft15">
											...
											<span style="color:#999999; font-size:15px;"> Pls add your Hotel expenses of trip to claim  </span>
                                        </h4>
                                        <form action="<?php echo base_url('my_expense/others'); ?>"  enctype="multipart/form-data" method="post">
                                            <div class="row">
                                                <div class="col-md-12">
												   ...
												   <div class="form-group col-xs-12">
                                                 <label class="control-label text-left-imp">Hotel Name<span class="required" aria-required="true"> * </span>:</label>                                     <input class="form-control required" name="hotal_name" aria-required="true" id="hotal_name" type="text">
                                                    </div>
                                                    <div class="form-group col-xs-12">
                                                        <label class="control-label text-left-imp">Check-In Date<span class="required" aria-required="true"> * </span>:</label>                                    
                                                        <div class="input-group date form_datetime">
                                                        <input name="check_in_date" id="check_in_date"  class="form-control" size="16" type="text" value="" readonly>
                                                        <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                    </div>
                                                    </div>
													
													<div class="form-group col-xs-12">
                                                        <label class="control-label text-left-imp">Check-Out Date<span class="required" aria-required="true"> * </span>:</label>                                    
                                                        <div class="input-group date form_datetime">
                                                 ...
                                                 <label class="control-label text-left-imp">Room No.:</label>    
                                                  <input class="form-control required" name="room_no" aria-required="true" id="room_no" type="text">
                                                    </div>
                                              ...
                                              <option value="Own">Own</option>
                                                <option value="Company">Company</option>
                                                  ...
                                                  <div class="form-group col-xs-12">
                                                 <label class="control-label text-left-imp">Bill No<span class="required" aria-required="true"> * </span>:</label>                                     <input class="form-control required" name="bill_no" aria-required="true" id="bill_no" type="text">
                                                 ...
                                                 <label class="control-label text-left-imp">Amount<span class="required" aria-required="true"> * </span>:</label>                                     <input class="form-control required" name="amount" aria-required="true" id="amount" type="number">
                                                    ...
                                                    <div class="form-group col-xs-12">
                                                        <label class="control-label text-left-imp">Attach<span class="required" aria-required="true"> * </span>:</label>                                                                            
                                                        <input class="form-control required" name="flight_attachment" aria-required="true" type="file">
                                                    </div>
