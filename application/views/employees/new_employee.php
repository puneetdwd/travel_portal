        ...
        <div class="col-md-12">
            <div class="portlet light bordered" id="form_wizard_1">
                ...
                <div class="portlet-body form">
                    <form method="post" action="<?php echo base_url('employee_update/update'); ?>" class="form-horizontal" id="submit_form" enctype="multipart/form-data">
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="required form-control" id="employee_id" name="employee_id" 
                                                       autocomplete="off" value="<?php echo isset($id) ? $id : ''; ?>">                                                
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="required form-control email validate-email" id="email_check" name="gi_email" 
                                                       autocomplete="off" value="<?php echo isset($employee['email']) ? $employee['email'] : ''; ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">State
                                                        <span class="required"> * </span></label>
                                                    <div class="col-md-9">
                                                        <select id="l-state_new"  name="l_state" class="form-control required select2me"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">City
                                                        <span class="required"> * </span></label>
                                                    <div class="col-md-9">
                                                        <select id="l-city_new"  name="city_id" class="form-control required select2me"
