...
class Finance_desk_model extends CI_Model {
    ...
    public function get_travel_requests() {
		...
		left join indian_cities toCity on travel_request.to_city_id = toCity.id  where travel_request.status='active' and travel_request.approval_status='Approved' and travel_request.request_status='6' and expense.expense_status ='Approved'";
