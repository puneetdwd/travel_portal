...
class Travel_rejected_reasons_model extends CI_Model {

    public function get_all_travel_reasons() {

        $sql = "SELECT * from travel_rejected_reasons t WHERE t.status = 'active'";
    ...
    public function get_travel_reasons($id) {
        ...
        $sql = "SELECT * from travel_rejected_reasons WHERE id=?";
    ...
    public function get_travel_reasons_combination($reason, $hangout_suggestion) {
        $sql = "SELECT id from travel_rejected_reasons WHERE reason = ? and hangout_suggestion = ?";
    ...
    public function update_travel_reasons($data, $travel_reasons_id) {
        ...
        if (!empty($travel_reasons_id)) {
            ...
            $result = $this->db->update('travel_rejected_reasons', $data);
            if ($result) {
            ...
            $result = $this->db->insert('travel_rejected_reasons', $data);
            if ($result) {
