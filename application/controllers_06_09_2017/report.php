...
class Report extends Admin_Controller {
    ...
    function get_admin_report_graph(){
        ...
        $request = $this->report_model->get_admin_report_graph($grade_id, $cost_center_id, $city_id, $state_id, $travel_mode, $dept_id, $start_date, $end_date);
		...
		$this->load->view('report/get_admin_report_graph', $view_data);
    }
