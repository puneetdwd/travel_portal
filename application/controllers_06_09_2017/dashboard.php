...
//        $sql = "ALTER TABLE `expense` ADD `expense_da` FLOAT NOT NULL AFTER `reimbursement_arrangment`, ADD `expense_con` FLOAT NOT NULL AFTER `expense_da`, ADD `policy_meet` TINYINT NOT NULL AFTER `expense_con`;";
//        $result = $this->db->query($sql);
//        $result->result_array();
//        po($result);
