...
<div class="page-content">
    ...
    <div class="breadcrumbs">
        ...
        <legend class="border-bottom-none">Bus Request</legend>
        <div class="pull-mob">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date form_datetime" data-date="<?php echo isset($travel_request['departure_date']) ? date('Y-m-d', strtotime($travel_request['departure_date'])) : date("Y-m-d"); ?>T07:00:00Z" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input1">
                                        <input name="departure_date" id="departure_date"  class="form-control required" size="16" type="text" value="<?php echo isset($travel_request['departure_date']) ? date('Y-m-d H', strtotime($travel_request['departure_date'])).":00:00" : date("Y-m-d H").":00:00"; ?> " readonly>
                                    ...
                                    if (isset($travel_request)) {
                                        if (isset($travel_request['return_date'])) {
                                            if ($travel_request['return_date'] == '0000-00-00 00:00:00') {
                                                ...
                                                $return_date = date('Y-m-d H', strtotime($travel_request['return_date'])).":00:00";
//                                                $return_date = $travel_request['return_date'];
                                    ...
                                    <div class="input-group date form_datetime" data-date="<?php echo isset($travel_request['departure_date']) ? date('Y-m-d', strtotime($travel_request['departure_date'])) : date("Y-m-d", strtotime("+1 day")); ?>T07:00:00Z" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input1">
