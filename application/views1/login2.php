                ...
                <div class="box box-body">
                    ...
                    <form class="login-form" method="post">
                        ...
                        <div class="row">                            
                            <div class="col-md-12 form-group">                                
                                <div class="input-group">
                                    ...
                                    <input type="text" autocomplete="off" autofocus placeholder="Alias" name="username" required class="form-control form-control-solid placeholder-no-fix form-group">
                                </div>
                            </div><br><br><br>
                        ...
                        <div class="row">
                            ...
                            <a class="btn green" target="_blank" href="https://docs.google.com/document/d/e/2PACX-1vT3R6KJA9B0l8FKINXzuO80cLrl4F4EwXcB2xrJcgPEKjlA-7cpgmrVPreOm8XLpZbB4KKPuKHmVeu0/pub">User Guide</a> &nbsp;&nbsp;&nbsp;
