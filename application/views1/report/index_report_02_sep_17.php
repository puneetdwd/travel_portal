        ...
        <div class="row"><br>
            <div class="col-md-2">
                <div class="input-group date form_datetime" data-date="<?php echo date("Y-m-d"); ?>" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
                    <input name="start_date" id="start_date"  class="form-control" size="16" type="text" value="" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
            </div>
            <div class="col-md-1 text-center">
                <label for="dtp_input1" class="control-label"><b>To</b></label>
            </div>
            <div class="col-md-2">
                <div class="input-group date form_datetime" data-date="<?php echo date("Y-m-d"); ?>" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
                    <input name="end_date" id="end_date"  class="form-control" size="16" type="text" value="" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
            </div>
            <div class="col-md-1 text-center">
...
<script type="text/javascript">
    ...
    $('#top_count,#grade_id,#cost_center_id,#state_id,#travel_mode,#dept_id,#start_date,#end_date').change(function () {
        get_admin_report();
    });
