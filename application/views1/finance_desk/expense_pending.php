                                    ...
                                    <table id="da_perticulars" class="table table-hover table-bordered text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $request['to_city_name']; ?></td>
                                                <td><?php echo $day . " Day," . $hours . " hours"; ?></td>
...
<?php echo $da_total; ?>
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-3">
                                                <?php if ($request['request_status'] != "8") { ?>
                                                    <input type="text" name="less_advance" onkeyup="received_total()" id="less_advance" value="<?php echo $expense_pending['less_advance']; ?>" class="form-control">
                                                <?php } else { ?>
    <?php echo $expense_pending['less_advance']; ?>
<?php } ?>
                                            </th>
                                        </tr>
                                        <tr>
                            ...
                            <input type="hidden" id="your_recived_hidd" name="your_recived_hidd">
                            <?php
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() . 'finance_desk/audit_expense/' . $request['id']; ?>" id="approval_task" method="post" class="validate-form form-horizontal row-border">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="total_claim" id="total_claim" value="<?php echo $expense_pending['final_total_claim']; ?>">
