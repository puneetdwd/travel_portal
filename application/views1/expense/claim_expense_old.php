...
//                                                            if (!empty($expense_details)) {
                                                        echo date('Y-m-d H', strtotime($request['return_date'])) . ":00:00";                                                        
//                                                            }
                                                        ?>">
                                                    ...
                                                    <tr id="<?php echo "row_trip_id_" . $i ?>">
                                                        ...
                                                        <td>
                                                            <div class="input-group date form_datetime" data-date="<?php echo date("Y-m-d", strtotime("+1 day")); ?>T07:00:00Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                                                                <input style="width:150px !important;" name="trip_date[]" id="trip_date"  class="form-control" size="16" type="text" value="<?php echo $value['trip_date'] ?>" readonly>
                                                                <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                            </div>
                                                        </td>
...
//                                                        $lbltotal = $lbltotal + $value['total']; 
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><b id='other_trip_total'><?php echo $total;
                                            ?></b></td>
                                            </tr>
                                        </tfoot>
                                    </table> 
                                            ...
                                            if (!empty($hotel_details)) {
                                                foreach ($hotel_details as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-md-1">
                                                            <input type="text" class="form-control required" id="bill_no_1" maxlength="15" name="bill_no_1" value="<?php echo $value['bill_no_1']; ?>">
                                                        </td>
                                                ...
                                                <tr id="<?php echo "row_load_id_" . $i ?>">
                                                    ...
                                                    <td>
                                                        <div class="input-group date form_datetime" data-date="<?php echo isset($flight_request['departure_date']) ? $flight_request['departure_date'] : date("Y-m-d", strtotime("+1 day")); ?>T07:00:00Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                                                            <input style="width:100px !important;" name="loading_departure[]" id="departure_date"  class="form-control" size="16" type="text" value="<?php echo $value['loading_departure']; ?>" readonly>
                                                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group date form_datetime" data-date="<?php echo isset($flight_request['departure_date']) ? $flight_request['departure_date'] : date("Y-m-d", strtotime("+1 day")); ?>T07:00:00Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                                                            <input style="width:100px !important;" name="loading_return[]" id="loading_return"  class="form-control" size="16" type="text" value="<?php echo $value['loading_return']; ?>" readonly>
                                                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                        </div>
                                                    </td>
...
//                                                        $total_travel_claim_hidd = $total_travel_claim_hidd - $other_expensetxt;
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="10">If Company Guest House is not available, View Ticket should available here</td>
                                    ...
                                    <table id="da_perticulars" class="table table-hover table-bordered text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>
                                                    <input type="hidden" value="<?php echo $request['departure_date']; ?>" name="departure_date" id="departure_date">
                                                    <?php echo $request['departure_date']; ?>
                                                </td>
                                                <td id="lbl_da_return_date">
                                                    <?php echo $request['return_date']; ?>
                                                </td>
                                                <td><?php echo $request['to_city_name']; ?></td>
                                                <td id="lbl_day"><?php
                                                ...
                                                <td  class="col-md-2">
                                                    ...
                                                    if ($request['DA_allowance_actual'] != '1') {
                                                        ...
                                                        ?>
                                                        <input type="number" class="only_number form-control required" name="da_allowance" id="da_allowance"  onkeyup="received_total()" placeholder="DA/Per day" value="<?php if (!empty($expense_details)) echo $request['DA_allowance']; ?>">                                                                                                                
                                                        <?php
                                                    }
                                                    ?>
                                    ...
                                    <table id="conveyance_car" class="table table-hover table-bordered text-center">
                                        ...
                                        <tbody id="con_tbody">
                                            ...
                                            foreach ($car_details as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group date form_datetime" data-date="<?php echo date("Y-m-d", strtotime("+1 day")); ?>T07:00:00Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                                                            <input style="width:150px !important;" name="con_date_1" id="con_date_1"  class="form-control" size="16" type="text" value="<?php echo $value['date'] ?>" readonly>
                                                            <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                        </div>
                                                        <?php // echo $value['date']     ?>
                                                    </td>
                                            ...
                                            if (!empty($other_con_booking)) {
                                                foreach ($other_con_booking as $key => $value) {
                                                    ...
                                                    <tr id="<?php echo "row_con_id_" . $i ?>">
                                                        ...
                                                        <td>
                                                            <div class="input-group date form_datetime" data-date="<?php echo date("Y-m-d", strtotime("+1 day")); ?>T07:00:00Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                                                                <input style="width:150px !important;" name="con_date[]" id="con_date"  class="form-control" size="16" type="text" value="<?php echo $value['con_date'] ?>" readonly>
                                                                <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                            </div>
                                                        </td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="7"></td>
                                                <th>Total</th>
                                                <td><b id='other_con_total'><?php echo $total3; ?></b></td>
                                            </tr>
                                        </tfoot>
                                    </table> 
                                    ...
                                    <table id="other_expense" class="table table-hover table-bordered text-center">
                                        ...
                                        <tbody id="tbody"> 
                                            <?php if (isset($other_manager_expense)) { ?>
                                                <tr>
                                                    <td></td>
                                                    <td></td>
                                                    <td>Other Expense by Travel Manager </td>
                                                    <td><?php
                                            ...
                                            if (!empty($other_expense)) {
                                                foreach ($other_expense as $key => $value) {
                                                    ...
                                                    <tr id="<?php echo "row_id_" . $i; ?>">
                                                        ...
                                                        <td><input type='text' name='bill_no[]' maxlength="15" id='<?php echo "bill_no_" . $i; ?>' value="<?php echo $value['bill_no']; ?>" class='form-control'></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="5"></td>
                                                <th>Total</th>
                                                <th id="other_total"><?php echo $total5;
                                            ?></th>
                                            </tr>
                                        </tfoot>
                                    </table> 
...
//                            $total_travel_claim_hidd = $total_travel_claim;
                        ...
                        ?>      
                        <input type="hidden" name="hidd_total_claim" id="hidd_total_claim" value="<?php echo $total_travel_claim_hidd_db; ?>" >
                        <input type="hidden" name="total_unpaid_claim_hidd" id="total_unpaid_claim_hidd" value="<?php echo $total_unpaid_claim_hidd; ?>" >
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th id="your_recived">
                                                <?php echo $total_unpaid_claim_show - $less_advance - $other_manager_expense; ?>
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="col-md-4">
                                <div class="col-md-offset-1 col-md-12">
                                    ** Pls attach all Bills, Upload Option&nbsp;<br>
                                    <input type="file" name="other_attachment[]" id="other_attachment" class="btn green button-submit" multiple="" accept="image/*" capture><br>
                                                    ...
                                                    function check_date() {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                ...
                                                                $("#lbl_da_return_date").text(return_date);
                                                                received_total();
                                                            }
                                                        });
...
//                                                        var Perhoure = 60 * 60 * 1000; // hours*minutes*seconds*milliseconds
//                                                        var firstDate = new Date(departure_date);
//                                                        var secondDate = new Date(return_date);
//                                                        var Days = Math.round(Math.abs((firstDate.getTime() - secondDate.getTime()) / (oneDay)));
//                                                        var total_houre = Math.round(Math.abs((firstDate.getTime() - secondDate.getTime()) / (Perhoure)));
//                                                        if (Days == '0') {
//                                                            Days = 1;
//                                                        }
//
//                                                        for (var hours = total_houre; hours >= 24; ) {
//                                                            hours = parseInt(hours) - parseInt(24);
//                                                        }
...
//                                                        $("#lbl_day").text(Days);
                                                    ...
                                                    function received_total() {
                                                        ...
                                                        $("#loading_total_final").text(other_load_total_final);
...
//                                                        hidd_total_claim = parseInt(hidd_total_claim) + parseInt(other_total);
                                                        ...
                                                        $("#other_trip_total").text(total_trip_lbl);
                                                        ...
                                                        $("#other_con_total").text(other_con_total);
                                                        ...
                                                        var your_recived = total_unpaid_claim_hidd - les_advance;
