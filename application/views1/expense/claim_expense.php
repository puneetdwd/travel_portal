...
//                                                        $lbltotal = $lbltotal + $value['total']; 
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><b id='other_trip_total'><?php echo $total.'.00';
                                            ?></b></td>
                                            </tr>
                                        </tfoot>
                                    </table> 
                                            ...
                                            if (!empty($hotel_details)) {
                                                foreach ($hotel_details as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="col-md-1">
                                                            <input type="text" class="form-control required" id="bill_no_1" maxlength="15" name="bill_no_1" value="
<?php  if($value['bill_no_1']==''){echo 0;}else{echo $value['bill_no_1'];}; ?>">
                                                        </td>
                                            ...
                                            <tr>
                                                ...
                                                <td  class="col-md-2">
                                                    ...
                                                    if ($request['DA_allowance_actual'] != '1') {
                                                        ...
                                                        ?>
                                                        <input type="number" class="only_number form-control required" name="da_allowance" id="da_allowance"  onkeyup="received_total()" placeholder="DA/Per day" value="<?php if (!empty($expense_details)) { echo $request['DA_allowance']; }else{echo 0;}  ?>">                                                                                                                
                                                        <?php
                                                    }
                                                    ?>
        ...
        <?php $total_travel_claim_hidd = $total_travel_claim_hidd - $value['total']; ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="7"></td>
                                                <th>Total ₹</th>
                                                <td><b id='other_con_total'><?php echo $total3.'.00'; ?></b></td>
                                            </tr>
                                        </tfoot>
                                    </table> 
