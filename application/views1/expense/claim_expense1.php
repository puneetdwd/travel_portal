                                    ...
                                    <table id="loading_hotel" class="table table-hover table-bordered text-center">
                                        <thead>
                                            <tr class="th_blue">
                                                ...
                                                <th>View<br> Bill</th>
                                                <th>Paid By</th>
                                                <th>Guest House/Hotel<br> Expense</th>
...
//                                                                var departure_date1 = moment(departure_date).format("<?php // echo DATETIME_FORMAT_JS;   ?>");
//                                                                var return_date1 = moment(return_date).format("<?php // echo DATETIME_FORMAT_JS;   ?>");
//                                                                alert(departure_date);
//                                                                alert(return_date);
//                                                                alert(departure_date1);
//                                                                alert(return_date1);
