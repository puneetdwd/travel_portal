    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <form action="<?php echo base_url('email_template/update'); ?>" role="form" class="validate-form" method="post">
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php // echo isset($email_template['variables']) ? $email_template['variables'] : ''; ?>
