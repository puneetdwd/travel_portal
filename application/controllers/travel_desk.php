...
//        po($view_request['request']);
    ...
    public function inbox() {
        ...
        if (!empty($cost_center_data)) {
            ...
            $request_arr = $this->travel_desk->get_all_travel_request($cost_center_id);
            $request = array();
            foreach ($request_arr as $key => $value) {
                $request[$value['id']] = $value;
            }
            ...
            $refund_request = $this->travel_desk->get_all_refund_request($cost_center_id);
...
//        po($request);
        ...
        if ($from_cost_center_id == $cost_center_id) {
            $view_request['booking_city_id'] = $from_city_id;
        } else {
            $view_request['booking_city_id'] = $request['to_city_id'];
        }
...
<p dir='ltr' style='line-height:1.2;margin-top:0pt;margin-bottom:0pt;'>
	<span id='docs-internal-guid-b1891aba-d014-7fb7-6550-94bb259e5555'><span style='font-size: 10pt; font-family: &quot;Trebuchet MS&quot;; color: rgb(0, 0, 0); background-color: transparent; vertical-align: baseline; white-space: pre-wrap;'>Pick-Up Date &amp; Time: " . date(DATETIME_FORMAT, strtotime($pick_up_date)) . "</span></span></p>
...
<div>
	&nbsp;</div>
";
                            $subject = " " . $request_data['reference_id'] . ",  From " . $request_data['from_city_name'] . " To " . $request_data['to_city_name'] . " Trip Car Booked";
                ...
                if (empty($check_booking)) {
                    ...
                    if ($this->common->insert_data($data_array, 'hotel_booking')) {
                        ...
                        if ($this->common->update_data($data_array, 'travel_request', 'id', $request_id)) {
                            ...
                            $request_data = $this->travel_request->get_request_details_by_id($request_id);
                            $message = "<p dir='ltr' style='line-height:1.2;margin-top:0pt;margin-bottom:0pt;'>
	<span ><span style='font-size: 10pt; font-family: &quot;Trebuchet MS&quot;; color: rgb(0, 0, 0); background-color: transparent; font-weight: 700; vertical-align: baseline; white-space: pre-wrap;'>Hi " . $request_data['employee_name'] . ",</span></span></p>
<p dir='ltr' style='line-height:1.2;margin-top:0pt;margin-bottom:0pt;'>
	&nbsp;</p>
<p dir='ltr' style='line-height:1.2;margin-top:0pt;margin-bottom:0pt;'>
...
<p dir='ltr' style='line-height:1.2;margin-top:0pt;margin-bottom:0pt;'>
	<span id='docs-internal-guid-b1891aba-d000-e20b-97dd-43adf5382d67'><span style='font-size: 10pt; font-family: &quot;Trebuchet MS&quot;; color: rgb(0, 0, 0); background-color: transparent; vertical-align: baseline; white-space: pre-wrap;'>Check-In Date: " . date(DATETIME_FORMAT, strtotime($check_in_date)) . "</span></span></p>
<p dir='ltr' style='line-height:1.2;margin-top:0pt;margin-bottom:0pt;'>
	<span id='docs-internal-guid-b1891aba-d000-e20b-97dd-43adf5382d67'><span style='font-size: 10pt; font-family: &quot;Trebuchet MS&quot;; color: rgb(0, 0, 0); background-color: transparent; vertical-align: baseline; white-space: pre-wrap;'>Check-out Date: " . date(DATETIME_FORMAT, strtotime($check_out_date)) . "</span></span></p>
<p dir='ltr' style='line-height:1.2;margin-top:0pt;margin-bottom:0pt;'>
...
";
                            ...
                            $subject = $request_data['reference_id'] . ", " . $request_data['to_city_name'] . " Trip Accommodation Booked";
                            $reference_id = $request['reference_id'];
                            $to = $request['email'];
                            $this->sendEmail($to, $subject, $message);
