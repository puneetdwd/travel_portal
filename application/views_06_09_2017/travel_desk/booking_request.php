                    ...
                    <div class="row">
                                    ...
                                    <div class="col-md-4 portlet light bordered paddingBottom10 set-boxes">
                                        <h4 class="form-section marginLeft15">
                                            <spam class="cutm_lbl btn_blue">
                                                Flight Ticket
                                            </spam><span style="font-size: 13px;">(<?php echo $request['from_city_name'] ?> To <?php echo $request['to_city_name'] ?>)</span>
                                        </h4>
                        ...
                        if ($request['accommodation'] == '1') {
                            if ($request['hotel_booking'] != '1') {
                                ?>
                                <div class="col-md-4 portlet light bordered set-boxes" style="padding-bottom: 4px;">
                                    <h4 class="form-section marginLeft15">
                                        <spam class="cutm_lbl btn_blue">
                                            Accommodation
                                        </spam>
                                    ...
                                    if ($request['trip_ticket_return'] != '1') {
                                        ...
                                        <div class="col-md-4 portlet light bordered paddingBottom10 set-boxes" >
                                            <h4 class="form-section marginLeft15">
                                                ...
                                                </spam><span style="font-size: 13px;">(<?php echo $request['to_city_name'] ?> To <?php echo $request['from_city_name'] ?>)</span>
                                            </h4>
                        ...
                        <?php if ($request['other_manager_expense'] == "0") { ?>
                            <div class="col-md-4 portlet light bordered paddingBottom10 set-boxes" >
                                <h4 class="form-section marginLeft15">
                                    <spam class="cutm_lbl btn_blue">
                                        Other Expenses <br>
                                    </spam><span style="font-size: 13px;">(Please Mention Other Expenses Of Traveler If Provided By Travel Desk )</span>
                                </h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group col-xs-12">
                                                ...
                                                <input type="number" min="0" class="form-control required" name="foods" id="foods">
                                            </div>                                        
                                            <div class="form-group col-xs-12">
                                                <label class="control-label text-left-imp">Travel<span class="required">*</span>:</label>                                    
                                                <input type="number" min="0" class="form-control required" name="travel" id="travel">
                                            </div>                                        
                                            <!--<div class="form-group col-xs-12">
