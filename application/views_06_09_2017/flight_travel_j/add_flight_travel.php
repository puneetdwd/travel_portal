...
<!--            <a class="btn btn_blue" href="<?php echo base_url('train_travel/index'); ?>">Train Travel</a> <div class="hidden-md hidden-lg hidden-xs"><br></div>
            ...
            <!--<a class="btn" href="javascript:void(0)" data-toggle="modal" data-target="#flight_modal"><img src="<?= base_url('assets/images/flight_search.ico'); ?>"></a>-->
        </div>
    </div>
    <!-- END PAGE HEADER-->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date form_datetime" data-date="<?php echo isset($flight_request['departure_date']) ? $flight_request['departure_date'] : date("Y-m-d"); ?>T07:00Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                                        <input name="departure_date" id="departure_date"  class="form-control" size="16" type="text" value="<?php echo isset($flight_request['departure_date']) ? $flight_request['departure_date'] : date("Y-m-d H") . ":00:00"; ?> " readonly>
                                ...
                                <div class="form-body">                
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="dtp_input1" class="control-label">Departure Date</label>
                                                <div class="input-group date form_datetime_j" data-date="<?= date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
                                                    <input name="departure_date" id="departure_date_j" class="form-control" size="16" value="<?= date('Y-m-d'); ?>" readonly="" aria-required="true" aria-invalid="false" type="text">
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                </div>
                                        ...
                                        <div class="col-md-2">
                                            <br>
                                            <button type="submit" class="btn btn-success" style="margin-top: 6px;">Search <span class="fa fa-arrow-right"></span></button>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date form_datetime_j" data-date="<?= date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
                                                    <input name="check_in_j" id="check_in_j" class="form-control" size="16" value="<?= date('Y-m-d'); ?>" readonly="" aria-required="true" aria-invalid="false" type="text">
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                                                </div>
                                                <input id="dtp_input1" value="" type="hidden"><br>
                                            </div>
...
<!--<script type="text/javascript" src="<?php echo base_url() . "/assets/assets/js/magic.js" ?>"></script>-->
<script type="text/javascript" src="https://cdn.datatables.net/1.10.15/js/jquery.dataTables.min.js"></script>

<script>
    $(document).ready(function () {
        $.getJSON("<?= base_url(); ?>/assets/data/airports.json", function (data) {
            var items = [];
...
//get vcid for hotel search city list
        $.getJSON("<?= base_url(); ?>/assets/data/hotel_city_list.json", function (data) {
            var items = [];
            var html = "<option value=''>Select city</option>";
            $.each(data, function (key, val) {
                //items.push( "<option value='" + val.iata + "'>" + val.iata + " (" + val.iata + ")</option>" );
...
//alert(newDate);
        $('#flight_search_form').submit(function (event) {
