        ...
        <div class="col-md-6">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-2 col-sm-12 col-xs-12 text-center title_div">
                    <a href="<?php echo base_url() . 'finance_desk/index/1'; ?>" class="cutm_theme_blue">
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 text-center title_div">
                    <a href="<?php echo base_url() . 'finance_desk/index/2'; ?>" class="cutm_theme_blue">
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 text-center title_div">
                    <a href="<?php echo base_url() . 'finance_desk/index/3'; ?>" class="cutm_theme_blue">
                    ...
                    <tbody>
                        ...
                        foreach ($request as $k => $data) {
                            ...
                            <tr>
                                ...
                                <td align="center"><?php 
                                if($data['policy_meet'] == "0") {                                    
                                    ?><i class="fa fa-times" style="color:red;font-size: 22px"></i><?php
                                } else {
                                    ?><i class="fa fa-check" style="color:green;font-size: 22px"></i><?php
                                }
                                ?></td>
