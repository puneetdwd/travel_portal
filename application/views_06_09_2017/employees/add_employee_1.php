                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Alias
                                                <span class="required"> * </span></label>
                                            <div class="col-md-4">
                                                <input type="text" class="required form-control" id="alias" name="alias" minlength="2"
                                    ...
                                    <div class="tab-pane" id="tab5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="alias">
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="dd_user_input">
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">EA of Manager:</label>
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="dd_user_input1">
                                                </p>
                                            </div>
                                        </div>
