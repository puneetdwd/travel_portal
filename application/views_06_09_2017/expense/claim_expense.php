        ...
        <?php $total_travel_claim_hidd = $total_travel_claim_hidd - $value['total']; ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="7"></td>
                                                <th>Total ₹</th>
                                                <td><b id='other_con_total'><?php echo $total3 . '.00';
                                                $expense_con = $total3;
                                                ?></b></td>
                                            </tr>
                                        </tfoot>
                                            ...
                                            if (!empty($other_expense)) {
                                                foreach ($other_expense as $key => $value) {
                                                    ...
                                                    <tr id="<?php echo "row_id_" . $i; ?>">
                                                        ...
                                                        <option <?php if($value['expense_name']==$OtherExpenceData['id']){?> selected <?php } ?> value="<?php echo $OtherExpenceData['id'];?>"><?php echo $OtherExpenceData['expense_name'];?></option>
                                                        <?php } }?>
                                                        </select>
                                                        
                                                        <?php /*?><input type='text' name='expense_name[]' id='<?php echo "expense_name_" . $i; ?>' value="<?php echo $value['expense_name']; ?>" class='form-control required'><?php */?></td>
