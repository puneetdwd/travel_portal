                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="255" class="required form-control" name="reason"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="class">Hangout Suggestion:
                                        <span class="required">*</span></label>                                        
                                    <?php $hangout_suggestion = isset($travel_reasons['hangout_suggestion']) ? $travel_reasons['hangout_suggestion'] : ''; ?>
                                    <select class="required form-control" name="hangout_suggestion">
                                        <option value="">Select</option>
                                        <option value="Yes" <?php if ($hangout_suggestion == 'Yes') echo "selected"; ?>>Yes</option>
                                        <option value="No" <?php if ($hangout_suggestion == 'No') echo "selected"; ?>>No</option>
                                    </select>                                        
                                    <span class="help-block">
                                    </span>
                                </div>
