                ...
                <form role="form" class="validate-form" method="post">
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="class">Half Day Rate:
                                        <span class="required">*</span></label>                                        
                                    <input type="number" class="required form-control" name="half_amount"
                                           value="<?php echo isset($car['half_amount']) ? $car['half_amount'] : ''; ?>">
                                    <span class="help-block">
                                    </span>
                                </div>
                            </div> 
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="class">Full Day Rate:
                                        <span class="required">*</span></label>                                        
