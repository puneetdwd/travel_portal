        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-2 text-center title_div"> 
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <?php foreach ($last_few_request as $key => $value) {
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <span class="col-md-10"><b><?php echo $value['from_city_name'] . " TO " . $value['to_city_name']; ?></b>
                                            <?php
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <?php foreach ($last_few_task as $key => $value) {
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <span class="col-md-10"><b><?php echo $value['from_city_name'] . " TO " . $value['to_city_name']; ?></b><?php
