...
//        $return_date = ($this->input->post('return_date'));
//        if (trim($departure_date) != '' && trim($return_date) != '') {
//            $sql = "SELECT * FROM travel_request WHERE departure_date <= '".date('Y-m-d H:i:s', strtotime($departure_date))."' and return_date >='".date('Y-m-d H:i:s', strtotime($return_date))."'";
