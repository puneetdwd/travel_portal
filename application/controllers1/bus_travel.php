...
class Bus_travel extends Admin_Controller {
...
//        $this->is_user_admin();
    ...
    public function index($travel_request_id = '') {
        ...
        if ($employee_id != '') {
            ...
            $bus_date = $this->travel_category->get_all_bus_category();
            $view_data['bus_category'] = $bus_date;
            ...
            $policy_data = $this->travel_policy_model->get_travel_policy_by_grade($grade_id, $service_type = '4');
...
//            }
            ...
            $traverl_class_data = $this->travel_request->get_travel_class_by_grade($grade_id, $service_type = '4');
...
//                $member_list = $this->input->post('member_list');
                ...
                if ($data) {
                    ...
                    if ($post_data['approval_level'] == 0) {
                        ...
                        if (!empty($email_template)) {
                            ...
                            if ($return_date == '') {
                                $request_data['travel_datetime'] = $departure_date;
                                ...
                                $request_data['travel_datetime'] = $departure_date . " To " . $return_date;
                            }
            ...
            $this->template->write_view('content', 'bus_travel/add_bus_travel', $view_data);
