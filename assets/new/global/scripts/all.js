...
var table = $('#make-data-table');
        var table_1 = $('#make-data-table_1');
        var table_2 = $('#make-data-table_2');
        var table_3 = $('#make-data-table_3');
        var table_4 = $('#make-data-table_4');
        var table_5 = $('#make-data-table_5');
        
        var ticket_table = $('#ticket_table');
        var loading_hotel = $('#loading_hotel');
        var da_perticulars = $('#da_perticulars');
        var conveyance_car = $('#conveyance_car');
        var other_expense = $('#other_expense');
...
//            "bStateSave": true, // save datatable state(pagination, sort, etc) in cookie.
        ...
        // begin first table
        loading_hotel.dataTable({
//                "order": [[0, "desc"]],
                "paging":   false,                
                "ordering" : false,
                "searching": false,"bInfo" : false,
                // Internationalisation. For more info refer to http://datatables.net/manual/i18n
                "language": {
                "aria": {
                "sortAscending": ": activate to sort column ascending",
